...
module.exports = {
    peerHost: process.env.PEER_HOST || defaultVars.PEER_HOST,
    eventHost: process.env.EVENT_HOST || defaultVars.EVENT_HOST,
    ordererHost: process.env.ORDERER_HOST || defaultVars.ORDERER_HOST,
    ...
    tlsEnabled: defaultVars.TLS_ENABLED,
