        ...
        invoke(user, invokeRequest, start) {
            ...
            return this.get_member_user(user)
                .then( async user_from_store =>{
                    ...
                    var fs = require('fs');
                    config.peerPem = fs.readFileSync('/home/luatcoi/Project/src/Lab/blockchain_go/driving-files/crypto-config/peerOrganizations/org2/peers/peer0.org2/tls/ca.crt');
                    config.peerDomain = "peer0.org2";
                    config.peerHost = "18.136.187.101:30601";
